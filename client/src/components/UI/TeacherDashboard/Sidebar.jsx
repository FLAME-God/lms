...
import { assets } from '../../../assets/clientImage/assets'
import { NavLink } from 'react-router-dom'

function Sidebar() {
    const sidebarLinks = [
        { name: "Dashboard", path: "/dashboard", icon: assets.dashboardIcon },
        { name: "Add Course", path: "/dashboard/add-course", icon: assets.addIcon },
        { name: "List Course", path: "/dashboard/list-course", icon: assets.listIcon },
